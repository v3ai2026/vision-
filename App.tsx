...
const App: React.FC = () => {
  ...
  const handleGithubDeploy = async () => {
    ...
    try {
      ...
      const description = githubRepoDescription || `Generated by Neural Agent OS - ${generationResult.projectName}`;
      const repo = await github.provisionProject(githubRepoName, description, false);
      ...
      await github.pushAtomicUpdate(user.login, githubRepoName, files, `feat: initial project setup - ${generationResult.projectName}`);
                    ...
                    <>
                      <div className="border-t border-white/5 pt-6 space-y-4">
                        <NeuralInput 
                          ...
                          placeholder={generationResult.projectName.toLowerCase().replace(/\s+/g, '-')}
                        />
